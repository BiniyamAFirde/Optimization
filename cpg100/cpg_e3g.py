...
# -*- coding: utf-8 -*-
"""
cpg_e3g.py -- optional node E3g: bring the 520 ms force closer to the baseline (inhibition, floor 4)
=========================================================================
...
W.E0_VERSION = "cpg_e3g 1.0 (final recipe at 520 ms, E->InE->F gain scan; cpg_small 1.3)"

...
# -*- coding: utf-8 -*-
"""
cpg_e5b.py -- roadmap node E5b: RG-F adaptation between d 4 and d 2, input floor 4, 3 gaits
=========================================================================
...
W.E0_VERSION = "cpg_e5b 1.0 (cpg_e2 presets; cpg_small 1.3 --rgf-c/--rgf-d, --indeg-min 4)"

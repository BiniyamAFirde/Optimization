...
# -*- coding: utf-8 -*-
"""
cpg_variantQ_k050_m040_fixedweights.py 
...
# Scale factors 
_m, _k = 0.40, 0.25   #  k=0.25, m=0.40 (deeper connectivity cut, same gate+IaF fixes as S)
...
def main():
    ...
    nest.ResetKernel()
    # seed the NEST kernel too, not just numpy
